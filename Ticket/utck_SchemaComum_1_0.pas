...
// targetNameSpace: http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaComum_1.0.xsd
// NameSpacePrefix: mstns
// Date of Schema : 02/07/2012 11:39:52
// Translationdate: 02/07/2012 11:46:17
//
...
const
  thisNamespaceURI = 'http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaComum_1.0.xsd';
  defNamespaceAlias = '';
...
begin
  ...
  begin
    ...
    if (sn = snEndereco_CEP) then
      ...
      CodigoCidade := StrToIntDef(xn.text, 0)
...
begin
  ...
  xn.text := IntToStr(FCodigoCidade);
