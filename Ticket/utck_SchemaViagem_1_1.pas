...
// targetNameSpace: http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaViagem_1.1.xsd
// NameSpacePrefix: mstns
// Date of Schema : 25/06/2012 15:49:58
// Translationdate: 25/06/2012 16:38:18
//
...
const
  ...
  cFormaDePagamento_Cartao = 'Cartao';

const
  snParcela = 'v:Parcela';
  snParcela_FormaDePagamento = 'v:FormaDePagamento';
...
const
  ...
  anViagem_referencia = 'v:referencia';
...
const
  thisNamespaceURI = 'http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaViagem_1.1.xsd';
...
begin
  ...
  begin
    ...
    if (sn = snParcela_FormaDePagamento) then
      FormaDePagamento :=  xn.text // string
    else if (sn = snParcela_Vencimento) then
...
begin
  ...
  xn := aNode.addChildByName(nsName(_NameSpaceAlias, snParcela_FormaDePagamento));
...
begin
  ...
  begin
    ...
    if sn = anViagem_referencia then
...
procedure tViagem.Setreferencia(value:string);
begin
  Freferencia := value;
...
//  end;
  ...
  if referencia_IsSet_ then
    aNode.attribute[anViagem_referencia] := Freferencia;
