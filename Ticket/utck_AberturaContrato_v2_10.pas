unit utck_AberturaContrato_v2_10;
...
// targetNameSpace: http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaFrete_2.1.xsd
// NameSpacePrefix: mstns
// Date of Schema : 25/06/2012 15:50:26
// Translationdate: 25/06/2012 16:34:10
//
//   includes c=http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaComum_1.2.xsd in 'SchemaComum_1.2.pas'
//   includes v=http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaViagem_1.1.xsd in 'SchemaViagem_1.1.pas'
...
type
  ...
  private
    ...
    FCiotPrincipal: tNumeroCiot; // (E)
    FCiotPrincipal_IsSet_: boolean;
    procedure SetCiotPrincipal(value:tNumeroCiot);
  public
    constructor Create; overload;
    constructor Create(aRoot:tJanXMLNode2); overload;
    destructor Destroy; override;
    ...
    property CiotPrincipal: tNumeroCiot read FCiotPrincipal write SetCiotPrincipal;
...
const
  thisNamespaceURI = 'http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaFrete_2.1.xsd';
...
procedure tConsignatario.SetEmail(value:string);
begin
  FEmail := value;
  FEmail_IsSet_ := true;
end;

procedure tConsignatario.SetTelefone(value:string);
begin
  FTelefone := value;
...
begin
  ...
  begin
    ...
    if (sn = snContratante_TipoPessoa) then
      ...
      CiotPrincipal :=  xn.text // tNumeroCiot
    else;
    xn := xn.NextSibling;
  end; // while Assigned(xn) do ...
end; // constructor ...
...
procedure tContratante.SetCiotPrincipal(value:tNumeroCiot);
begin
...
procedure tCiot.SetViagem(value:tViagem);
begin
  FViagem := value;
  FViagem_IsSet_ := true;
end;
...
//  end;
  ...
  begin
    xn := aNode.addChildByName(nsName(_NameSpaceAlias, snCiot_Viagem));
    FViagem.Save( xn );
  end;
end; // procedure save
...
begin
  ...
  aNode.attribute['xmlns']     := 'http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaFrete_2.1.xsd';
  aNode.attribute['xmlns:c']   := 'http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaComum_1.2.xsd';
  aNode.attribute['xmlns:v']   := 'http://lote.homologacaoticketfrete.com.br/CDN/fretelote/schemas/SchemaViagem_1.1.xsd';
//  aNode.attribute['xmlns:xsi'] := 'http://www.w3.org/2001/XMLSchema';
