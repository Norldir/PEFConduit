unit urdc_DetalharViagem_v1_01;
...
type
  ...
  private
    ...
    FDetalharViagemResponse: tDetalharViagemResponse; // (E)
  public
    constructor Create; overload;
    constructor Create(aRoot:tJanXMLNode2); overload;
    destructor Destroy; override;
...
begin
  ...
  begin
    ...
    else if (sn = snDetalharViagemResponse_TipoViagem)
