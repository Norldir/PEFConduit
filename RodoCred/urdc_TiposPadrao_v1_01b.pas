...
// NameSpacePrefix: rdc
// Date of Schema : 09/05/2012 15:27:26
// Translationdate: 09/05/2012 16:03:57
//
...
type
  ...
  private
    ...
    FLocalidadeDestino: string; // (E)
    FLocalidadeDestino_IsSet_: boolean;
    FCodigoIBGEDestino: tCodigoIBGEType; // (E)
    FCodigoIBGEDestino_IsSet_: boolean;
    procedure SetUFDestino(value:string);
    procedure SetLocalidadeDestino(value:string);
  ...
  public
    ...
    procedure Save(aNode:tJanXMLNode2);
    property _NameSpaceAlias: string read F_NameSpaceAlias write F_NameSpaceAlias;
    property UFDestino: string read FUFDestino write SetUFDestino;
    property UFDestino_IsSet_:boolean read FUFDestino_IsSet_;
    property LocalidadeDestino: string read FLocalidadeDestino write SetLocalidadeDestino;
...
type
  ...
  private
    ...
    FLocalidadeOrigem: string; // (E)
    FLocalidadeOrigem_IsSet_: boolean;
    FCodigoIBGEOrigem: tCodigoIBGEType; // (E)
    FCodigoIBGEOrigem_IsSet_: boolean;
    procedure SetUFOrigem(value:string);
    procedure SetLocalidadeOrigem(value:string);
  ...
  public
    ...
    property LocalidadeOrigem: string read FLocalidadeOrigem write SetLocalidadeOrigem;
...
type
  ...
  private
    F_NameSpaceAlias: string;
    FCodigoRota: integer; // of tCodigoRota(E)
  ...
  public
    ...
    procedure Save(aNode:tJanXMLNode2);
    property _NameSpaceAlias: string read F_NameSpaceAlias write F_NameSpaceAlias;
    property CodigoRota: integer read FCodigoRota write FCodigoRota; // of tCodigoRota
...
type
  ...
  public
    ...
    property Embarque: tDateTime read FEmbarque write FEmbarque;
...
begin
  ...
  begin
    ...
    if (sn = snDestinoRota_UFDestino) then
      UFDestino :=  xn.text // string
    else if (sn = snDestinoRota_LocalidadeDestino) then
      LocalidadeDestino :=  xn.text // string
...
procedure tDestinoRota.SetUFDestino(value:string);
begin
  FUFDestino := value;
  FUFDestino_IsSet_ := true;
end;

procedure tDestinoRota.SetLocalidadeDestino(value:string);
begin
...
begin
  ...
  begin
    ...
    if (sn = snOrigemRota_UFOrigem) then
      UFOrigem :=  xn.text // string
    else if (sn = snOrigemRota_LocalidadeOrigem) then
      LocalidadeOrigem :=  xn.text // string
...
procedure tOrigemRota.SetUFOrigem(value:string);
begin
  FUFOrigem := value;
  FUFOrigem_IsSet_ := true;
end;

procedure tOrigemRota.SetLocalidadeOrigem(value:string);
begin
...
begin
  ...
  begin
    ...
    if (sn = snImpostosViagem_ValorTotalImpostos) then
      ValorTotalImpostos :=  DefStrToFloat( xn.text,0) // tValorType
...
begin
  ...
  xn.text := MyFloatToStr(FValorTotalImpostos);
...
begin
  ...
  begin
    ...
    if (sn = snVeiculosViagem_PlacaVeiculo) then
      ...
      QtdeEixos :=  StrToIntDef(xn.text,0) // tEixoType
...
begin
  ...
  if NumeroTransacao_IsSet_ then
  begin
